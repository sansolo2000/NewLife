...
@section('title', 'Crear nueva respuesta')
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            @endif
            <form action="{{ url('admin/notes/'.$Nota->noji_id.'/respond') }}" method="post" enctype="multipart/form-data">
                @csrf 

                <div class="card bg-secondary">
                    <div class="card-header">
                        <h3 class="card-title">{{ $Nota->noji_asunto }}</h3>
