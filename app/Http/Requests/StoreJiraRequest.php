...
class StoreJiraRequest extends FormRequest
{
    /**
    ...
    {
    return [
        'jira_codigo.required'                  => 'El :attribute es obligatorio.',
        'jira_codigo.unique'                    => 'El :attribute debe ser único.',
        'jira_codigo.min'                       => 'El :attribute debe tener más 5 caracteres',
        'jira_codigo.max'                       => 'El :attribute debe tener máximo 15 caracteres',
    ...
    {
        $previa = [
            'jira_codigo'                   => 'required|max:15|min:5|unique:jiras',
